 ...
 * @author barryf
 */
abstract public class BasicApplication2 extends Composite {
     ...
     * Constructor.
     */
    public BasicApplication2(Shell parent) {
        this(parent, SWT.NONE);  // must always supply parent
    }
    /**
     * Constructor.
     */
    public BasicApplication2(Shell shell, int style) {
    ...
    public static void run(String appName, String title, int style, int width, int height, String[] args) {
        ...
        try {
            ...
            BasicApplication2 app = (BasicApplication2)ctor.newInstance(new Object[] {shell, new Integer(style)});
            app.createGui(args);
            app.initGui();
