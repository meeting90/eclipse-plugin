 ...
 * <ul>
 *   <li>{@link cn.edu.nju.workflow.model.impl.ConditionalOutputPortImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ConditionalOutputPortImpl extends OutputPortImpl implements ConditionalOutputPort {
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.CONDITIONAL_OUTPUT_PORT;
	}
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.CONDITIONAL_OUTPUT_PORT__CONDITION, oldCondition, condition));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.CONDITIONAL_OUTPUT_PORT__CONDITION:
				return getCondition();
		}
