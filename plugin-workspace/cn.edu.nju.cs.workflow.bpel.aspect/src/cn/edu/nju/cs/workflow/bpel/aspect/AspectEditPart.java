...
public class AspectEditPart extends BPELEditPart implements ILayoutAware{
	...
	private class ProcessOrderedHorizontalLayoutEditPolicy extends AspectEditPart.ProcessOrderedLayoutEditPolicy{
		@Override
		...
		return new MarqueeDragTracker() {
			...
			protected void handleFinished() {
				if (getViewer().getSelection().isEmpty()) {
					...
					getViewer().setSelection(new StructuredSelection(AspectEditPart.this));
				}
			}
		};
	}
