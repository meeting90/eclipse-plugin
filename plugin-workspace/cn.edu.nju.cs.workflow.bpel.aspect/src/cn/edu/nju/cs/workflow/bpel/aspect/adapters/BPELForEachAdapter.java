...
import org.eclipse.bpel.ui.adapters.ForEachAdapter;
...
public class BPELForEachAdapter extends ForEachAdapter {


	@SuppressWarnings("rawtypes")
	@Override
	public IContainer createContainerDelegate() {
		return new BPELActivityContainer(BPELPackage.eINSTANCE.getForEach_Activity());
	}
