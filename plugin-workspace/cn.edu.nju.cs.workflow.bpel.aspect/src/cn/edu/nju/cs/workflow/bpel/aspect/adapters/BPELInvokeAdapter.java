...
import org.eclipse.bpel.ui.adapters.InvokeAdapter;
...
import cn.edu.nju.cs.workflow.bpel.aspect.actions.BPELSetPartnerLinkAction;
import cn.edu.nju.cs.workflow.bpel.aspect.actions.BPELSetVariableAction;

public class BPELInvokeAdapter extends InvokeAdapter {
	...
	public List<AbstractAction> getEditPartActions(final EditPart editPart) {
		...
		actions.add(new BPELSetPartnerLinkAction(editPart));
		actions.add(new BPELSetVariableAction(editPart, BPELSetVariableAction.REQUEST));
		actions.add(new BPELSetVariableAction(editPart, BPELSetVariableAction.RESPONSE));
		return actions;
	}
