...
import cn.edu.nju.cs.workflow.bpel.aspect.actions.BPELCreateOnAlarmAction;
import cn.edu.nju.cs.workflow.bpel.aspect.actions.BPELCreateOnMessageAction;
import cn.edu.nju.cs.workflow.bpel.aspect.actions.BPELCreateTerminationHandlerAction;

public class BPELPickAdapter extends PickAdapter {
	...
	public List<AbstractAction> getEditPartActions(final EditPart editPart) {
		...
		ICompensationHandlerHolder ich = AdapterRegistry.INSTANCE.adapt(modelObject, ICompensationHandlerHolder.class);
		...
		actions.add(new BPELCreateOnMessageAction(editPart));
		actions.add(new BPELCreateOnAlarmAction(editPart));
