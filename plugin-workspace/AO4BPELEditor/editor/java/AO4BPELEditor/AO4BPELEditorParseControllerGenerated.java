...
public class AO4BPELEditorParseControllerGenerated extends DynamicParseController 
{ 
  public static final String LANGUAGE = new String("AO4BPELEditor");
  ...
  { 
    AO4BPELEditorParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = AO4BPELEditorParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = AO4BPELEditorParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(AO4BPELEditorParseControllerGenerated.class);
    }
  ...
  { 
    return AO4BPELEditorParseController.class.getProtectionDomain().getCodeSource().getLocation().getFile();
  }
