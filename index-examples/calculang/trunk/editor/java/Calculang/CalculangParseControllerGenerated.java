...
public class CalculangParseControllerGenerated extends DynamicParseController 
{ 
  ...
  { 
    CalculangParseControllerGenerated.descriptor = descriptor;
  }
  ...
  { 
    try
    { 
      InputStream descriptorStream = CalculangParseControllerGenerated.class.getResourceAsStream(DESCRIPTOR);
      InputStream table = CalculangParseControllerGenerated.class.getResourceAsStream(TABLE);
      ...
      descriptor.setAttachmentProvider(CalculangParseControllerGenerated.class);
    }
